...
in Feross's JavaScript Standard Style, or check out some of
...
The easiest way to use Feross's JavaScript Standard Style to check your code is to install it
...
### Why would I use Feross's JavaScript Standard Style?

The beauty of Feross's JavaScript Standard Style is that it's simple. No one wants to maintain
...
Feross's JavaScript Standard Style uses [`eslint`](http://eslint.org/) under-the-hood and you can
...
Lint the provided source `text` to enforce Feross's JavaScript Standard Style. An `opts` object may
be provided:
